...
import example.pageobjects.RentOrderPage;
...
public class OrderStatusTest extends BaseTest {
    ...
    public void enterOrderAllDataTest() {
        ...
        pageobjects.HomePage objHomePage = new pageobjects.HomePage(driver);
        ...
        new pageobjects.OrderDataPage(driver)
        ...
        new pageobjects.WishOrder(driver)
                //нажимаю кнопку Да в окне Хотите оформить заказ?
                .clickOkButton();
        //создаю объект страницы Заказ оформлен
        pageobjects.OrderIsProcessed objOrderIsProcessed = new pageobjects.OrderIsProcessed(driver);
